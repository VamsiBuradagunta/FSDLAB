...
const HotelBillScreen = () => {
  ...
  const items = [
    { id: 1, name: 'Idly', cost: 20 },
    { id: 2, name: 'Dosa', cost: 35 },
    { id: 3, name: 'Vada', cost: 25 },
    { id: 4, name: 'Poori', cost: 30 },
    { id: 5, name: 'Parota', cost: 50 },
    { id: 6, name: 'Chapati', cost: 40 },
    { id: 7, name: 'Dum-Biriyani', cost: 250 },
    { id: 8, name: 'Chilli-Chicken', cost: 145 },
    { id: 9, name: 'Gobi-Manchuria', cost: 85 },
    { id: 10, name: 'Tomato Rice', cost: 50 },
  ];
...
const handlePrint = () => {
  ...
  return (
    ...
    >
      <h2 style={{ textAlign: 'center', color: '#333' }}>VAMSI'S Hotel Invoice</h2>
  ...
  >
    Add Item
      ...
      <div className="watermark">CH. Manjunath</div>
    </div>
  );
};
